...
import (
	...
	"github.com/MrityunjayRoy/prod-go-boilerplate/internal/logger"
	"github.com/MrityunjayRoy/prod-go-boilerplate/internal/server"
...
func GetLogger(c echo.Context) *zerolog.Logger {
	...
	// fallback to basic logger is not found
	logger := zerolog.Nop()
	return &logger
}
